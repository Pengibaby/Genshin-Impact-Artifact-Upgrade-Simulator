/*
 * A class to simulate the feather artifact piece.
 */
public class FeatherPiece extends Artifacts {
	
	private String artifactName;
	private String MainStatName;
	private int[] MainStatValues = {47, 100, 152, 205, 258, 311};
	private int numberOfLevelUps;
	private String[] substatNames;
	private double[] substatValues;
	
	/**
	 * Constructor for the FeatherPiece class
	 */
	public FeatherPiece() {
		//Initialise values
		this.artifactName = "Feather";
	...
	/**
	 * A function that will level the feather piece by +4 ranks, and upgrade a random substat.
	 */
	public void levelFeatherPiece(int index) {
	...
	/**
	 * A function that returns the name of the artifact: Feather.
	 * @return			name of the artifact: Feather
	 */
	...
	/**
	 * A function that returns the current level of the feather piece
	 * @return			current feather piece level
	 */
	...
	/**
	 * A function that prints out all the stats of the Feather piece
	 */
